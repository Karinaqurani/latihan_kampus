...
import 'package:latihan_kampus/screen_page/page_detail_kampus.dart';
import 'package:latihan_kampus/screen_page/page_maps_all.dart';
...
class _KampusListState extends State<KampusList> {
  ...
  Future<ModelKampus> fetchKampus() async {
    final response = await http.get(Uri.parse('http://192.168.110.237/kampusDB/getKampus.php'));
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: NetworkImage(
                                        'http://192.168.110.237/kampusDB/gambar/${kampus.gambarKampus}'),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
